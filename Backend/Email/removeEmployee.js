export default function getRemoveEmployeeMailOptions(
  ...
  return {
    ...
    to: email,
    subject: "AI Knots-System Account Removal Notification",
    html: `<!DOCTYPE html>
      <html lang="en">
      <head>
        <meta charset="UTF-8">
      ...
      <body>
        <div class="container">
          <div class="header">
            <img src="https://hrms-software-for-ai-knots-it-solution-3.onrender.com/assets/download.jpg" alt="AI KNOTS Logo" class="logo" />
            <div class="title">Account Removal Notification</div>
          </div>
          <div class="content">
            <p>Dear <strong>${name}</strong>,</p>
            <p>Your account as <strong>${position}</strong> in <strong>${department}</strong> has been removed from the AI Knots System.</p>
